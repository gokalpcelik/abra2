...
public class ReAlignerOptions extends Options {
	...
	private static final String REGION_PADING = "pad";
	...
	protected OptionParser getOptionParser() {
    	if (parser == null) {
            ...
            parser.accepts(GKL, "If specified, use the GKL Intel Deflater.");
			...
			parser.accepts(REGION_PADING, "Padding applied to all regions in the bed file if specified.").withOptionalArg().ofType(Long.class).defaultsTo(0L);
    	}
	...
	public long getRegionPadding()
	{
		return (Long) getOptions().valueOf(REGION_PADING);
	}
